...
function preload(){
  // 先使用本地 fonts 目录，确保站点可直接运行
  tFont[0] = loadFont("fonts/Milligram-Medium.ttf");
  tFont[1] = loadFont("fonts/BebasNeue-Regular.ttf");
  tFont[2] = loadFont("fonts/DelaGothicOne-Regular.ttf");
  tFont[3] = loadFont("fonts/TimesNewRoman-Regular.ttf");
  tFont[4] = loadFont("fonts/TimesNewRoman-Bold.ttf");

  tFontData[0] = loadBytes("fonts/Milligram-Medium.ttf");
  tFontData[1] = loadBytes("fonts/BebasNeue-Regular.ttf");
  tFontData[2] = loadBytes("fonts/DelaGothicOne-Regular.ttf");
  tFontData[3] = loadBytes("fonts/TimesNewRoman-Regular.ttf");
  tFontData[4] = loadBytes("fonts/TimesNewRoman-Bold.ttf");
